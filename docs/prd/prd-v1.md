...
| **同溫層牆** | Venting | P1 | B5 | Phase 2 | 貼文流、發起聚會、聚會管理 |
...
| **SilentBuffer** | 同溫層牆宣洩貼文 | `/venting` | P1 | Phase 2 |
...
| **登入** | 用戶身份認證 | P0 | Phase 1 | 認證系統 |
| **註冊** | 用戶註冊 | P0 | Phase 1 | 認證系統 |
| **個人儀表板** | 用戶主頁（簡化版：用戶資訊 + 快速操作） | P0 | Phase 1 | 個人儀表板 |
| **通知中心** | 系統通知管理 | P0 | Phase 1 | 通知系統 |
| **建立救援請求** | 發起救援需求 | P0 | Phase 1 | 救援功能 |
| **救援請求詳情** | 查看請求狀態與 Helper 資訊 | P0 | Phase 1 | 救援功能 |
| **Helper 註冊** | 註冊成為 Helper | P0 | Phase 1 | Helper 功能 |
| **Helper 儀表板** | Helper 接案管理 | P0 | Phase 1 | Helper 功能 |
| **個人儀表板（完整版）** | 擴展版：加入救援請求列表、聚會列表 | P1 | Phase 2 | 個人儀表板 |
| **個人資料** | 個人資料設定 | P1 | Phase 2 | 個人資料管理 |
| **通知設定** | 通知偏好設定 | P1 | Phase 2 | 通知系統 |
| **選擇 Helper** | 選擇匹配的 Helper | P1 | Phase 2 | 救援功能 |
| **Helper 檔案** | Helper 個人檔案與業績 | P1 | Phase 2 | Helper 功能 |
| **Helper 設定** | Helper 狀態與技能管理 | P1 | Phase 2 | Helper 功能 |
| **應對錦囊** | 生成應對腳本 | P1 | Phase 2 | 應對錦囊 |
| **貼文流** | 同溫層牆貼文流 | P1 | Phase 2 | 同溫層牆 |
| **發起聚會** | 發起節慶聚會 | P1 | Phase 2 | 同溫層牆 |
| **聚會列表** | 瀏覽可用聚會 | P1 | Phase 2 | 同溫層牆 |
| **聚會詳情** | 查看聚會資訊與參與者 | P1 | Phase 2 | 同溫層牆 |
| **開始測驗** | 角色診斷測驗 | P2 | Phase 3 | 角色診斷 |
| **診斷報告** | 查看診斷結果 | P2 | Phase 3 | 角色診斷 |
| **實況地圖** | 地圖視覺化中心 | P2 | Phase 3 | 實況地圖 |
| **邊界說明書** | 個人社交邊界管理 | P2 | Phase 4 | 邊界說明書 |
| **邊界分享頁** | 邊界說明書分享頁（公開） | P2 | Phase 4 | 邊界說明書 |
...
#### 對象層級決策
1. **User 與 Helper 一對一關係**：一個 User 只能有一個 Helper 身份（Phase 1/MVP 階段）
...
- **Phase 1（MVP）**：僅包含核心救援功能與 Helper 匹配機制
  - 不包含：個人資料設定、通知設定、Helper 檔案/設定、應對錦囊、同溫層牆、角色診斷、實況地圖、邊界說明書
- **Phase 2**：擴展核心功能，實作應對錦囊與同溫層牆
- **Phase 3**：實作角色診斷與實況地圖
- **Phase 4**：實作邊界說明書
